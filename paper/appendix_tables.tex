...
Counts after the Phase 1 exclusions, for negative-sampling seed 0. The
target ratio is 2.14, the maximum achievable uniformly across the cohort;
two participants fall short because their eligible negative pool is
exhausted before the target is met.
...
7A & 248 & 526 & 2.12 \\
83 & 314 & 672 & 2.14 \\
8B$^{\dagger}$ & 74 & 97 & 1.31 \\
94$^{\dagger}$ & 34 & 73 & 2.15 \\
BG & 154 & 331 & 2.15 \\
E4 & 310 & 663 & 2.14 \\
F5 & 116 & 248 & 2.14 \\
\midrule
Total & 1579 & 3236 & 2.05 \\
\bottomrule
\end{tabular}
\caption{Cohort and negative construction. $\dagger$ marks the two participants whose achieved ratio falls below the 2.14 target.}
\end{table}
